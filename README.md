...
- This folder contains the full [write-up](/Python/Galaxy-Orbits-simulation/Computing-project-final.pdf) and [program](/Python/Galaxy-Orbits-simulation/Orbit-Calculator.py) of a project to investigate the formation of galactic structures. In particular, the formation
